...
class LoadQuantity(models.Model):
    size = models.CharField(primary_key=True, max_length=50)  # The composite primary key (size, ffucount) found, that is not supported. The first column is selected.
    ffucount = models.IntegerField()
